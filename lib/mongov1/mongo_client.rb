...
module MongoV1
  ...
  class MongoClient
    ...
    include MongoV1::Networking
    include MongoV1::WriteConcern
    include MongoV1::Authentication
    ...
    def use_write_command?(write_concern)
      write_concern[:w] != 0 && primary_wire_version_feature?(MongoV1::MongoClient::BATCH_COMMANDS)
    end
    ...
    def setup(opts)
      ...
      if @ssl
        ...
        @socket_class = MongoV1::SSLSocket
      elsif @unix
        @socket_class = MongoV1::UNIXSocket
      else
        @socket_class = MongoV1::TCPSocket
      end
