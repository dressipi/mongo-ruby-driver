...
module MongoV1
  class URIParser
    ...
    OPT_VALID = {
      :authmechanism           => lambda { |arg| MongoV1::Authentication.validate_mechanism(arg) },
    ...
    OPT_ERR = {
      :authmechanism           => MongoV1::Authentication::MECHANISM_ERROR,
    ...
    OPT_CONV = {
      ...
      :w                       => lambda { |arg| MongoV1::Support.is_i?(arg) ? arg.to_i : arg.to_sym },
    ...
    # Create a MongoV1::MongoClient or a MongoV1::MongoReplicaSetClient based on the URI.
    #
