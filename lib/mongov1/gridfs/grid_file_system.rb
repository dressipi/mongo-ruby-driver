...
module MongoV1
  ...
  class GridFileSystem
    ...
    def initialize(db, fs_name=Grid::DEFAULT_FS_NAME)
      raise MongoArgumentError, "db must be a MongoV1::DB." unless db.is_a?(MongoV1::DB)
      ...
      begin
        ...
        @chunks.ensure_index([['files_id', MongoV1::ASCENDING], ['n', MongoV1::ASCENDING]], :unique => true)
    ...
    def open(filename, mode, opts={})
      ...
      if mode == 'w'
        ...
        rescue MongoV1::ConnectionFailure => e
