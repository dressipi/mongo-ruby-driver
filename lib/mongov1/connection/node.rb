...
module MongoV1
  class Node
    ...
    def inspect
      "<MongoV1::Node:0x#{self.object_id.to_s(16)} @host=#{@host} @port=#{@port}>"
    end
    ...
    def update_max_sizes
      ...
      @max_write_batch_size = config['maxWriteBatchSize'] || MongoV1::MongoClient::DEFAULT_MAX_WRITE_BATCH_SIZE
    end
  end
end
